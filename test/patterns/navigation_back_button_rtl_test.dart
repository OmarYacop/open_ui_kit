...
void main() {
  group('UiNavigationBackButton history flyout RTL (PR-2)', () {
    ...
    testWidgets(
        'flyout starts aligned with the trigger left edge in LTR',
        (tester) async {
      ...
      expect(
        ...
        reason:
            'LTR flyout should start no further right than the trigger',
      );
    });

    testWidgets(
        'flyout starts aligned with the trigger right edge in RTL',
        (tester) async {
      ...
      expect(
        ...
        reason:
            'RTL flyout should start no further left than the trigger',
      );
    });
  });
}
