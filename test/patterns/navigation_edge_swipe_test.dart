...
void main() {
  ...
  Future<T> runWith<T>(TargetPlatform p, Future<T> Function() body) async {
  ...
  group('UiNavigationHost edge-swipe pop (PR-E)', () {
    ...
    testWidgets('edge-swipe is a no-op when the stack is at the root', (
      ...
      await runWith(TargetPlatform.iOS, () async {
        ...
        await tester.pumpWidget(
          _host(
            UiNavigationHost(controller: controller, enableEdgeSwipePop: true),
          ),
        );
        await tester.pumpAndSettle();
    ...
    testWidgets('enableEdgeSwipePop = false disables the gesture on iOS', (
      ...
      await runWith(TargetPlatform.iOS, () async {
        ...
        await tester.pumpWidget(
          _host(
            UiNavigationHost(controller: controller, enableEdgeSwipePop: false),
          ),
        );
        await tester.pumpAndSettle();
