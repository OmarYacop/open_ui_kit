...
void main() {
  testWidgets(
    'shows only the selection until expanded, then collapses on pick',
    (tester) async {
      ...
      final expandedRect = tester.getRect(expandedSurface);
  ...
  testWidgets('expanded surface follows its anchor and clips progressively', (
    ...
    final expanded = find.byKey(const Key('compact_choice_expanded_surface'));
