...
void main() {
  group('UiPersistentSheet inner-scroll arbitration (PR-5)', () {
    testWidgets(
      ...
      'index is unchanged',
      (tester) async {
        final sheetController = UiPersistentSheetController(
          initialIndex: 1,
        ); // max snap
    ...
    testWidgets('at bottom + upward drag does NOT collapse the sheet below its '
